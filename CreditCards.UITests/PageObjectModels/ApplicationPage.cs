...
public class ApplicationPage
{
    ...
    public static readonly string Title = "Credit Card Application - Credit Cards";
    ...
    public ReadOnlyCollection<IWebElement> ValidationErrors =>
        _driver.FindElements(By.CssSelector(".validation-summary-errors > ul > li"));
